...
<html lang="en">
    ...
    <body>
        ...
        <div class="text-center">
            <p class="text-base font-semibold text-amber-400">@yield('code')</p>
            ...
            <a href="{{ route('home') }}" class="rounded-md bg-amber-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-amber-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">Go back home</a>
