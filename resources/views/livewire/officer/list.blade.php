...
<div class="space-y-4">
    <x-page-heading title="Data Petugas" description="Kelola data petugas yang dapat melakukan pengambilan makanan." />
                ...
                <flux:menu>
                    ...
                    <flux:menu.submenu heading="Department">
                        <flux:menu.radio.group wire:model.live="departmentFilter" >
                            ...
                            @foreach (\App\Models\User::query()->petugas()->select('department')->distinct()->whereNotNull('department')->pluck('department') as $dept)
